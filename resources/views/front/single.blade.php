							...
							<ul class="comment-tree list-unstyled">
								<li class="mb-5">
									<div class="comment-area-box">
										<img loading="lazy" alt="comment-author" src="{{ asset('assets/front/images/blog/test1.jpg') }}" class="img-fluid float-left mr-3 mt-2">
								...
								<li>
									<div class="comment-area-box">
										<img loading="lazy" alt="comment-author" src="{{ asset('assets/front/images/blog/test2.jpg') }}" class="mt-2 img-fluid float-left mr-3">
			...
			<div class="col-lg-4 mt-5 mt-lg-0">
				<div class="sidebar-wrap">
					...
					<div class="sidebar-widget card border-0 mb-3">
						<img loading="lazy" src="{{ asset('assets/front/images/blog/blog-author.jpg') }}" alt="blog-author" class="img-fluid">
					...
					<div class="sidebar-widget latest-post card border-0 p-4 mb-3">
						...
						<div class="media border-bottom py-3">
							<a href="#"><img loading="lazy" class="mr-4" src="{{ asset('assets/front/images/blog/bt-3.jpg') }}" alt="blog"></a>
						...
						<div class="media border-bottom py-3">
							<a href="#"><img loading="lazy" class="mr-4" src="{{ asset('assets/front/images/blog/bt-2.jpg') }}" alt="blog"></a>
							<div class="media-body">
						...
						<div class="media py-3">
							<a href="#"><img loading="lazy" class="mr-4" src="{{ asset('assets/front/images/blog/bt-1.jpg') }}" alt="blog"></a>
							<div class="media-body">
